...
(function() {
  ...
  setPreviewImage = function(watermarkfile) {
    var newImage, reader;
    ...
    reader.onload = function(evt) {
      ...
      return $("#change-avatar-form").submit();
    };
    return reader.readAsDataURL(watermarkfile);
  };

  $(document).ready(function() {
    $(".content-container").removeClass("hide");
    $(".edit-password-container, .edit-profile-container").addClass("hide");
    $(".edit-form-link").bind("click", function() {
      $(this).addClass("orange");
      $(".change-pass-form-link").removeClass("orange");
      $(".edit-profile-container").removeClass("hide").fadeIn("slow");
      return $(".content-container, .edit-password-container").addClass("hide");
    });
    $(".change-pass-form-link").bind("click", function() {
      $(this).addClass("orange");
      $(".edit-form-link").removeClass("orange");
      $(".edit-profile-container, .content-container").addClass("hide");
      return $(".edit-password-container").removeClass("hide").fadeIn("slow");
    });
    $(".cancel-edit-profile").bind("click", function() {
      ...
      return $(".content-container").removeClass("hide").fadeIn("slow");
    });
    $(".submit-edit-profile-link").click(function() {
      return $(".submit-edit-profile").click();
    });
    $(".submit-change-password-link").click(function() {
      return $(".submit-change-password").click();
    });
    $("#email-change-password").click(function() {
      return $(".form-email-change-password").submit();
    });
    $(".disconnect-facebook").click(function() {
      return $(".image-disconnect-facebook").show().fadeIn("slow");
    });
    $(".disconnect-google").click(function() {
      return $(".image-disconnect-google").show().fadeIn("slow");
    });
    $("#upload-avatar-profile").bind("change", function(evt) {
      var files;
      evt.preventDefault();
      files = evt.target.files;
      if (files[0].size >= 10000000) {
        return alert("File can't be more than 10 MB");
      } else {
        return setPreviewImage(files[0]);
      }
    });
    $(".input-about").keyup(function() {
      var char, len, max;
      max = 200;
      len = $(this).val().length;
      if (len > max) {
        $(".text-max").text(" you have reached the limit");
        return $(".text-max").css("color", "red");
      } else {
        $(".text-max").text("Maximum Character: 200");
        char = max - len;
        $(".text-remaining").text(char);
        return $(".text-max").addClass("dark-grey");
      }
    });
    $(".input-about").blur(function() {
      return $(".text-remaining").empty;
    });
    return $(".input-new-password").keyup(function() {
      var len, min, val;
      min = 6;
      val = $(this).val();
      len = $(this).val().length;
      ...
      if (val.length === 0) {
        return $(".reject-number, .accept-number, .reject-character, .accept-character, .reject-symbol, .accept-symbol").addClass("hide").fadeIn();
      }
    });
  });
